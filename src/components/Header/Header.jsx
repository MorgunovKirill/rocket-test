                ...
                <nav className={classes.mainNav}>
                    ...
                    <ul className={classes.mainNav__list}>
                        <li className={classes.mainNav__item}>
                            <NavLink to="/favorites" className={classes.mainNav__link}>
